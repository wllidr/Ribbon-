...
class AutoTools(wx.Frame):
    ...
    def __init__(self, parent, title):
        ...
        menuftpserver = filemenu.Append(wx.ID_FILE8, "&Ftp服务器", "Ftp服务器开启......")
        filemenu.AppendSeparator()
        ...
        filemenu.AppendSeparator()
        menuregular = filemenu.Append(wx.ID_FILE9, "&正则提取参数", "自己写正则提取参数......")
    ...
    def OnSnScratch(self, event):
        ...
        button41 = wx.Button(self.panel, -1, '确认执行按钮', size=(180, 33))
