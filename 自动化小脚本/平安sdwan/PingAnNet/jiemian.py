...
class MyFrame(wx.Frame):
    ...
    def SWUI(self, event):
        ...
        swSysname = wx.TextCtrl(self.panel, size=(300, 30), style=wx.TE_READONLY)
        ...
        self.dns1Text = wx.TextCtrl(self.panel, size=(180, 30))
        self.dns2Text = wx.TextCtrl(self.panel, size=(180, 30))
        ...
        self.swAC1Text = wx.TextCtrl(self.panel, size=(180, 30))
        ...
        self.swAC2Text = wx.TextCtrl(self.panel, size=(180, 30))
        box3 = wx.BoxSizer()
    ...
    def FWUI(self, event):
        ...
        # 防火墙
        sysNameStatic = wx.StaticText(self.panel, -1, '设备名称:    ', style=wx.ALIGN_LEFT | wx.ST_ELLIPSIZE_MIDDLE)
        fwSysname = wx.TextCtrl(self.panel, size=(300, 30), style=wx.TE_READONLY)
        ...
        if 'D' in self.bussniessClass or 'E' in self.bussniessClass:
            ...
            portChoice1 = [''] + ['GigabitEthernet1/0/' + str(i) for i in range(3, 8)]
    ...
    def ACUI(self, event):
        ...
        for i in range(len(self.acFiles)):
            temp = 'acFileButton%s=wx.Button(self.panel, -1, "%s", size=(220, 33))' % (str(i), self.acFiles[i]['sysname'])
        ...
        # ACsysname
        sysNameStatic = wx.StaticText(self.panel, -1, '设备名称:    ', style=wx.ALIGN_LEFT | wx.ST_ELLIPSIZE_MIDDLE)
        self.acSysname = wx.TextCtrl(self.panel, size=(300, 30), style=wx.TE_READONLY)
        manageIpStatic = wx.StaticText(self.panel, -1, '  管理IP:    ', style=wx.ALIGN_LEFT | wx.ST_ELLIPSIZE_MIDDLE)
        self.manageIp = wx.TextCtrl(self.panel, size=(130, 30), style=wx.TE_READONLY)
        sysNameStatic.SetFont(font)
