...
def InitialVariables(excelPath):
    # print(excelPath)
    ...
    for j in range(3, num):
        ...
        # print(devices)
        if '核心' in temp[1] and ('S5720HI' in temp[0].upper() or ('S5720' in temp[0].upper() and 'HI' in temp[0].upper())  or ('S5720' in temp[2].upper() and 'HI' in temp[2].upper())):
            swModel = 'S5720HI'
        elif '核心' in temp[1] and ('S5720EI' in temp[0].upper() or ('S5720' in temp[0].upper() and 'EI' in temp[0].upper()) or ('S5720' in temp[2].upper() and 'EI' in temp[2].upper())):
            swModel = 'S5720EI'
