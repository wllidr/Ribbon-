...
class SinaSpider(RedisSpider):
    ...
    def start_requests(self):
        for urlId in self.start_urls:
            ...
            yield scrapy.Request(url=urlFans, meta={'blogger': urlId}, callback=self.parseFans, dont_filter=True)
            yield scrapy.Request(url=urlGroupName, meta={'blogger': urlId}, callback=self.parseGroupName,dont_filter=True)
            yield scrapy.Request(url=urlWeiBo, meta={'blogger': urlId}, callback=self.parseWeiBo, dont_filter=True)
