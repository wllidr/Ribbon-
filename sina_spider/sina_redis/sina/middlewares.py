...
# allDownloaderMiddleware
class SinaUseAgentChange(object):
    def process_request(self, request, spider):
        # 修改User-Agent
        agent = random.choice(AGENTS)
        request.headers["User-Agent"] = random.choice(agent)

class SinaCookieChange(object):
    def process_request(self, request, spider):
        cookie = random.choice(cookies)
        # cookie = {'SUB': '_2A252Us_HDeRhGeBL4lQX9SbIzDuIHXVVvNGPrDV6PUJbkdAKLUX9kW1NRq8uyHfDutPpcwMpbgY0GwNjP_0ctaCW',
        #           'SCF': 'AoY2kuHKFSZ1xiA-aMdFhC7pcbXKavcf4Q6Tz5paiWOfPK7COpMSm1ZmCBjPfGO2a40vgcOgwTEX6RfULMLCIC4.',
